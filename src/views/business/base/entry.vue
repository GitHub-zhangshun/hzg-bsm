        ...
        <el-tabs v-model="tabsName" id="custom_tabs" stretch>
          <el-tab-pane label="基本信息" name="baseInfo">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item prop="factoringId">
                  ...
                  <el-select v-model="baseForm.factoringId" filterable remote placeholder="请输入并选择保理机构" :remote-method="queryFactoringAsync" :clearable="true" popper-class="search-select">
                ...
                <el-form-item>
                  ...
                  <el-select v-model="baseForm.providerId" filterable remote placeholder="请输入并选择助贷机构" :remote-method="queryProviderAsync" :clearable="true" popper-class="search-select" :loading="selectLoading">
                ...
                <el-form-item prop="userId">
                  ...
                  <div class="searchItem">
                    ...
                    <el-select @focus="showBorrowerSearchType = true" v-model="baseForm.userId" filterable remote placeholder="请输入借款人" :remote-method="queryBorrowerAsync" :clearable="true" popper-class="search-select">
            ...
            <template v-if="baseForm.extendList && baseForm.extendList.length > 0">
              ...
              <el-row v-if="baseForm.extendList && baseForm.extendList.length > 0">
                <el-col :span="24">
            ...
            <el-row>
              <el-col :span="24">
                ...
                <el-form-item prop="periods">
                  ...
                  <el-input v-model="baseForm.periods" placeholder="请输入期数" :disabled="disablePeriods">
          ...
          <el-tab-pane label="信息披露" name="fkInfo">
            ...
            <section :id="`section-${index}`" class="info_section shadow" :style="section.showType === 'text' ? 'border-top: 2px solid #1D93F5;' : (section.showType === 'img' ? 'border-top: 2px solid #5CBA33;' : 'border-top: 2px solid #E29735;')" v-for="(section, index) in this.baseForm.discloseGroupList" :key="index">
  ...
  export default {
    ...
    data() {
      return {
        ...
        productTypeAttachInfo: {}, // 标的递增、单笔、限额信息
        borrowerSearchType: '1',
        showBorrowerSearchType: false,
        img: require('@/assets/borrowerSign.png')
      }
    },
    computed: {
      ...mapGetters([
    ...
    watch: {
      ...
      // 标的还款方式监听
      'baseForm.repayment': function(nd) {
    ...
    methods: Object.assign(_func(), {
      ...
      func_execute(action) {
        this.$refs['baseForm'].validate((valid) => {
          if (valid) {
            ...
            // 一次性还本付息
            if (repayment === 'bid_repay_one' && this.baseForm.periods !== '1') {
      ...
      seriesTypeChange(e) {
        ...
        if (!oldValue) {
          // 首次选择 直接获取模板
          this.getSeriesTemplate(e).then(() => {}).catch(() => {
      ...
      getSeriesTemplate(seriesType) {
        if (seriesType) {
          // 获取信息披露模板
          return this.getTypeEnum(this.typeEnumUrl, 'bid_template_info', seriesType).then(data => {
            if (data.length === 0) {
              return
            }
            // 获取模板key
