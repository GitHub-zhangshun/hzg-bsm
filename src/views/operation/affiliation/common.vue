    ...
    <div class="post-main-container">
      ...
      <el-dialog :close-on-click-modal="false" v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogBaseStatus" @close="dialogBaseClose">
        <el-form :model="dialogBaseForm" ref="dialogBaseForm" label-width="100px">
          <el-form-item label="选择机构部门">
            <el-treeselect value="请选择" placeholder="请输入搜索内容" :data="orgList" :props="orgItemProps" :isEdit="true" @nodeClick="orgItemClick">
            </el-treeselect>
          </el-form-item>
        </el-form>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      // 获取机构树
      this.$request({
        url: this.currentMenuHiddenRunFuncList['O_ORG_TREE_LIST']
      }).then(data => {
    ...
    methods: Object.assign(_func(), {
      ...
      // 树形机构点击
      orgItemClick(e) {
        this.dialogBaseForm.correlationId = e.Id
      }
    })
  }
</script>
