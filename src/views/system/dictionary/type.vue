  ...
  <div class="post-container">
    <div class="post-main-container">
      <div class="quickButton">
        <el-button-group>
          <el-button size="mini" @click="quickQuery('bid_interest_rate_type')">计息</el-button>
          <el-button size="mini" @click="quickQuery('bid_repay_type')">还款</el-button>
          <el-button size="mini" @click="quickQuery('bid_business_type')">业务</el-button>
          <el-button size="mini" @click="quickQuery('bid_borrow_type')">借款人</el-button>
          <el-button size="mini" @click="quickQuery('bid_info_type')">产品</el-button>
          <el-button size="mini" @click="quickQuery('bid_product_show_type')">产品显示类型</el-button>
          <el-button size="mini" @click="quickQuery('bid_product_fee_rate')">产品管理费</el-button>
          <el-button size="mini" @click="quickQuery('bid_product_rate')">产品利率</el-button>
        </el-button-group>
      </div>
  ...
  export default {
    data() {
      return {
        ...
        dialogTitle: '', // 当前弹窗标题
        affiliationType: '1', // 查询类型列表 自定义枚举
        tableListQuery: {
          type: '1'
        }
      }
