  ...
  <div class="post-container">
    <div class="post-main-container">
      ...
      <el-table stripe @row-dblclick="pitchRow" ref="table" :data="table.list" border style="width: 100%;margin-top:5px;" v-loading="table.loading" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="code" label="简写码">
        </el-table-column>
        <el-table-column prop="payUrl" label="中转地址" show-overflow-tooltip >
        </el-table-column>
      ...
      <el-dialog :close-on-click-modal="false" v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogBaseStatus" @close="dialogBaseClose">
        <el-form :model="dialogBaseForm" ref="dialogBaseForm" label-width="100px">
          ...
          <el-form-item label="简写码" prop="code">
            <el-input v-model="dialogBaseForm.code"></el-input>
          </el-form-item>
          <el-form-item label="支付中转页" prop="payUrl">
            <el-input v-model="dialogBaseForm.payUrl"></el-input>
          </el-form-item>
          ...
          <el-form-item label="单点登录" prop="isSso">
            <el-select v-model="dialogBaseForm.isSso" placeholder="请选择状态">
          ...
          case 'dialogEdit':
            if (row.length !== 1) {
              ...
              this.$request({
                ...
                this.dialogTitle = '修改客户端'
                this.dialogBaseStatus = true
                this.dialogBaseForm.isUse = data.result.isUse.toString()
                this.dialogBaseForm.isSso = data.result.isSso.toString()
              })
            }
            break
