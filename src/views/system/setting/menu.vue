<template>
  <div class="post-container">
    <div class="post-main-container">
      ...
      <!-- 菜单编辑 dialog -->
      <el-dialog :close-on-click-modal="false" v-el-drag-dialog :title="dialogAdd?'新增菜单':'修改菜单'" :visible.sync="dialogStatus" @close="dialogClose">
      ...
      <!-- 分配功能 dialog -->
      <el-dialog :close-on-click-modal="false" v-el-drag-dialog title="分配功能" :visible.sync="dialogActionStatus">
        <el-row>
        ...
        <div style="height: 300px;overflow:scroll;margin-top:5px;">
          <el-table stripe :data="actionOwnList" border style="width: 100%;margin-top:5px;" :row-class-name="tableRowClassName">
            ...
            <el-table-column prop="keyName" label="KEY">
            </el-table-column>
            <el-table-column label="位置">
              <template slot-scope="scope">
                <span>{{scope.row.isRight === 'true'?'右侧':'顶部'}}</span>
              </template>
            </el-table-column>
        ...
        <!-- 内层dialog 新增功能 -->
        <el-dialog :close-on-click-modal="false" v-el-drag-dialog :title="dialogActionAdd?'添加功能':'修改功能'" :visible.sync="dialogActionInnerStatus" append-to-body @close="dialogActionInnerClose">
          <el-form :model="dialogActionForm" ref="dialogActionForm" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
            ...
            <el-form-item label="KEY">
              <el-input v-model="dialogActionForm.keyName" auto-complete="off"></el-input>
            </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      distr(node) {
        ...
        this.$request({
          ...
          data.result.map(item => {
            item.isRight = item.isRight.toString()
          })
      ...
      editAction(e) {
        ...
        this.dialogActionForm.isRight = e.isRight
        // 开启内层dialog
        this.dialogActionInnerStatus = true
      },
      // 分配菜单功能内层确定事件
